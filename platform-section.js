...
#platforms .kz-platform-cta{display:inline-flex;align-items:center;min-height:48px;margin:14px 0 0;padding:0 22px;border:1px solid rgba(244,244,242,.62);color:#f4f4f2;font-size:11px;font-weight:700;letter-spacing:.08em;text-decoration:none;transition:border-color .2s ease,background .2s ease}
