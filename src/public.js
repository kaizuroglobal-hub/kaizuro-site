          ...
          rewriter
            ...
            .on('form.capture', {
              element(element) {
                const cookie = request.headers.get("Cookie") || "";
                if (cookie.split(";").some((part) => part.trim() === "kz_contact_status=submitted")) {
                  element.after('<input id="kz-success-toggle" type="checkbox" checked aria-label="Show confirmation"><div id="kz-success-modal" role="dialog" aria-modal="true" aria-label="KAIZURO confirmation"><div class="kz-success-backdrop"></div><div class="kz-success-card"><label class="kz-success-close" aria-label="Close confirmation" for="kz-success-toggle">×</label><div class="kz-success-eyebrow">KAIZURO</div><div class="kz-success-title">THANKS — YOU\'RE IN</div><div class="kz-success-copy">We\'ve received your email. Check your inbox for confirmation.</div><label class="kz-success-action" for="kz-success-toggle">CLOSE</label></div></div><style id="kz-success-modal-style">#kz-success-toggle{position:fixed;width:1px;height:1px;opacity:0;pointer-events:none}#kz-success-toggle:not(:checked)~#kz-success-modal{display:none!important}#kz-success-modal{position:fixed;inset:0;z-index:99999;display:grid;place-items:center;padding:24px;box-sizing:border-box;pointer-events:auto}#kz-success-modal .kz-success-backdrop{position:absolute;inset:0;background:rgba(0,0,0,.68);backdrop-filter:blur(5px);pointer-events:auto}#kz-success-modal .kz-success-card{position:relative;z-index:2;width:min(460px,calc(100vw - 48px));padding:42px 40px 36px;box-sizing:border-box;background:#080b0e;border:1px solid rgba(245,245,242,.9);box-shadow:0 24px 80px rgba(0,0,0,.5);text-align:center;color:#fff;font-family:Inter,Arial,sans-serif;pointer-events:auto}.kz-success-close{position:absolute;top:10px;right:12px;z-index:3;border:0;background:transparent;color:#fff;font-size:26px;line-height:1;cursor:pointer;padding:4px 8px;text-decoration:none}.kz-success-eyebrow{font-size:10px;font-weight:700;letter-spacing:.22em;margin-bottom:18px;opacity:.72}.kz-success-title{font-size:28px;font-weight:600;letter-spacing:.05em;line-height:1.15}.kz-success-copy{margin:14px auto 26px;max-width:330px;font-size:13px;line-height:1.55;opacity:.78}.kz-success-action{display:inline-block;min-width:120px;padding:12px 20px;border:1px solid rgba(245,245,242,.85);background:#f5f5f2;color:#111;font:700 10px/1 Inter,Arial,sans-serif;letter-spacing:.12em;cursor:pointer;text-decoration:none;position:relative;z-index:3}@media(max-width:640px){#kz-success-modal .kz-success-card{padding:38px 24px 30px}.kz-success-title{font-size:23px}}</style>', { html: true });
                }
              },
            })
            .on('#updates form', {
